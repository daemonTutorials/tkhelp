...
setup(
    ...
    data_files = ['test.gif', 'webinterface', ['webinterface/tkhelp.db']]],
    py_modules = ['tkhelp', 'tkh_splash3', 'tkhelp_lang_de', 'dt_tkobjects', 'webinterface/server', 'webinterface/tools/write', 'webinterface/getcontent']
    classifiers = [
